...
gh repo create "$repo_name" --description "$repo_description" --public --remote-url "https://github.com/$github_username/$repo_name.git" || { echo "❌ Failed to create repository $repo_name on GitHub."; exit 1; }
